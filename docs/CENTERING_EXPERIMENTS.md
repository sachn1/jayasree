...
**3. Smoothed**: corner-aware piecewise local-tangent fit (Part 3); jitter
gone, corners preserved.

![ജ, after corner-aware smoothing](centering-example/smoothed.svg)

**4. Straightened**: ghost-edge-guided angle correction (Part 4). For ജ
specifically this stage barely moves anything visible, since the letter is
